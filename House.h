...
void drawHouse2(GLfloat centerPosX, GLfloat centerPosY, GLfloat centerPosZ, GLfloat width, GLfloat height, GLfloat depth)
{
    // Roof height is 3/8 of the house height.
    const GLfloat roofHeight = height * 3.0 / 8.0;
    const GLfloat roofCenterPosY = centerPosY + roofHeight / 2.0;
    ...
    drawCube(centerPosX, doorWidth, doorCenterPosY, doorHeight, doorCenterPosZ-50, doorDepth, doorColor);
}
